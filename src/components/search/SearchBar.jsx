...
const SearchBar = () => {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 p-6 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 flex flex-col gap-4 transition-colors duration-500">
            <div className="flex flex-col sm:flex-row gap-4 w-full">
                {/* Search Bar */}
                <div className="flex-1 flex items-center pl-4 relative border-2 border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50 dark:bg-slate-950 focus-within:ring-4 focus-within:ring-fuchsia-500/20 focus-within:border-fuchsia-300 dark:focus-within:border-fuchsia-500 transition-all">
                    ...
                    <input
                        ...
                        className="w-full h-full min-h-[3rem] sm:min-h-[4rem] bg-transparent border-0 outline-none focus:ring-0 focus:outline-none text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 text-lg font-medium pr-4"
                    />
                </div>
                ...
                <div className="sm:w-64 shrink-0 relative">
                    <select 
                        ...
                        className="w-full h-full min-h-[3rem] sm:min-h-[4rem] px-5 py-2 bg-slate-50 dark:bg-slate-950 border-2 border-slate-200 dark:border-slate-800 rounded-2xl text-slate-700 dark:text-slate-300 font-bold focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-300 dark:focus:border-indigo-500 outline-none cursor-pointer appearance-none transition-all"
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    <div className="flex items-center gap-2 flex-1 sm:flex-none">
                        <input 
                            ...
                            className="w-24 px-4 py-2.5 bg-slate-50 dark:bg-slate-950 border-2 border-slate-200 dark:border-slate-800 rounded-xl font-bold text-slate-700 dark:text-slate-300 focus:border-fuchsia-300 dark:focus:border-fuchsia-500 focus:ring-4 focus:ring-fuchsia-500/20 outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-500"
                            min="0"
                        />
