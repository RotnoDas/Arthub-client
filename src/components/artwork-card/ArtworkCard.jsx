        ...
        <div className="group flex flex-col bg-slate-100 dark:bg-slate-900 rounded-3xl border-2 border-slate-300 dark:border-slate-800 shadow-xl shadow-slate-300/50 dark:shadow-none overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-fuchsia-500/30 dark:hover:border-fuchsia-500/50">
            <div className="relative overflow-hidden aspect-[4/3]">
                {artwork.image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-slate-50 dark:bg-slate-950 text-slate-400 dark:text-slate-600 text-sm font-medium">No Image Available</div>
                )}
                ...
                <div className="absolute top-4 right-4 z-10 flex flex-col gap-2 items-end">
                    ...
                    <Chip size="sm" className="font-bold shadow-lg shadow-black/20 bg-white/90 dark:bg-slate-950/80 backdrop-blur-md text-fuchsia-600 dark:text-fuchsia-400 border border-white/50 dark:border-slate-700">
            ...
            <div className="p-6 flex flex-col grow">
                <div className="space-y-2 mb-4">
                    <Link href={`/artworks/${artwork._id}`} className="block">
                        <h3 className="text-xl font-extrabold leading-tight line-clamp-1 text-slate-900 dark:text-white group-hover:text-fuchsia-600 dark:group-hover:text-fuchsia-400 transition-colors">
                            {artwork.title}
                        </h3>
                    </Link>
                ...
                <div className="pt-4 mt-auto border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
                    ...
                    {artwork.status === 'sold' ? (
                        <div className="flex items-center gap-2 font-bold text-sm bg-slate-200 dark:bg-slate-800 text-slate-400 dark:text-slate-500 rounded-xl px-5 py-2.5 shadow-inner cursor-not-allowed">
                            Sold Out
                        </div>
                    ) : (
                        <Link href={`/artworks/${artwork._id}`} className="flex items-center gap-2 font-bold text-sm bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl px-5 py-2.5 shadow-lg shadow-slate-900/20 dark:shadow-white/20 hover:bg-fuchsia-600 dark:hover:bg-fuchsia-500 hover:text-white hover:shadow-fuchsia-600/30 dark:hover:shadow-fuchsia-500/30 transition-all active:scale-95">
