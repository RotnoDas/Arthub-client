        ...
        <div className="mt-8 p-6 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 rounded-2xl relative transition-colors duration-500">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <Link href={`/dashboard/artist/add-artwork?edit=${artworkId}`} className="flex-1">
                    <Button className="w-full bg-background border border-amber-200 dark:border-amber-900/50 text-amber-700 dark:text-amber-500 font-bold hover:bg-amber-100 dark:hover:bg-amber-900/40 shadow-sm transition-all">
                        <FaEdit /> Edit Details
                    </Button>
                </Link>
                <Button
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
                    <div className="bg-background rounded-3xl shadow-2xl max-w-sm w-full p-6 animate-in zoom-in-95 duration-200 border border-transparent dark:border-slate-800">
                        ...
                        <div className="flex justify-end gap-3">
                            <Button variant="light" onPress={() => setIsOpen(false)} className="font-bold text-muted">
                                Cancel
                            </Button>
