        ...
        <div className="flex justify-center mt-16 pt-8 border-t border-border pb-16 transition-colors duration-500">
            <div className="flex items-center gap-2">
                <button
                    ...
                    className={`flex items-center gap-1 font-extrabold px-4 py-2 rounded-xl transition-colors mr-2 text-sm ${currentPage === 1
                ...
                {pages.map((page, index) => (
                    page === '...' ? (
                        ...
                        <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center font-extrabold rounded-full transition-all text-sm ${currentPage === page
                ...
                <button
                    ...
                    className={`flex items-center gap-1 font-extrabold px-4 py-2 rounded-xl transition-colors ml-2 text-sm ${currentPage === safeTotalPages
                        ? 'text-slate-300 dark:text-slate-700 cursor-not-allowed'
                        : 'bg-transparent hover:bg-slate-200 dark:hover:bg-slate-800 text-foreground'
                        }`}
                >
