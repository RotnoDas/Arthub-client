...
export default function AdminDashboardPage() {
    ...
    if (loading || !data) {
        return (
            <div className="py-20 flex justify-center">
                <div className="text-muted animate-pulse text-sm font-medium">Loading analytics...</div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Header */}
            <div>
                <h1 className="text-3xl font-bold text-foreground mb-1">Analytics Overview</h1>
                <p className="text-muted">A high-level snapshot of the ArtHub platform.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((stat) => {
                    ...
                    return (
                        <div key={stat.title} className={`rounded-2xl border border-border bg-background shadow-sm p-5 ring-1 ${stat.ring} dark:ring-0`}>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold text-muted uppercase tracking-wider">{stat.title}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border border-border bg-background shadow-sm p-6">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-base font-bold text-foreground">Artworks by Category</h3>
                    </div>
                    <div className="h-80 w-full">
