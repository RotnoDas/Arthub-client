...
export default function ArtistProfilePage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl">
      <div>
        <h1 className="text-3xl font-bold text-white mb-1">Artist Profile</h1>
        <p className="text-slate-400">Manage your ArtHub artist account.</p>
      </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 flex items-center gap-5">
        <div className="relative shrink-0">
          <img
            ...
            alt={user.name}
            className="w-20 h-20 rounded-full object-cover ring-2 ring-indigo-500/60 ring-offset-2 ring-offset-[#080c16]"
          />
          <span className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-indigo-500 border-2 border-[#080c16] flex items-center justify-center">
        ...
        <div>
          ...
          <span className="inline-block mt-1.5 px-2.5 py-0.5 rounded-full bg-indigo-500/10 text-indigo-400 text-[10px] font-bold uppercase tracking-wider">Artist</span>
        </div>
      </div>

      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-5">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-9 h-9 rounded-xl bg-indigo-500/10 text-indigo-400 flex items-center justify-center"><FaUser size={14} /></div>
          <div>
        ...
        <form onSubmit={handleProfileUpdate} className="space-y-4">
          ...
          <Button type="submit" isLoading={savingProfile} color="primary" className="font-semibold px-8">Save Profile</Button>
        </form>
      </div>

      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-5">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-9 h-9 rounded-xl bg-pink-500/10 text-pink-400 flex items-center justify-center"><FaLock size={14} /></div>
          <div>
